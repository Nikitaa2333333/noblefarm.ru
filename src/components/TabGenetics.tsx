...
import { PEDIGREE_2234 } from '../data/pedigrees';
...
export default function TabGenetics({ lang }: TabGeneticsProps) {
  ...
  return (
    <div className="w-full">
      ...
      {/* ─── Pedigree chart (horizontal bracket, cinematic) ─────────────── */}
      <section className="section-cinematic relative">
        <img
          src="/deer_cinematic_bg.webp"
          alt=""
          aria-hidden="true"
        ...
        <div className="section-inner relative z-10 flex flex-col gap-10">
          ...
          <PedigreeChart data={PEDIGREE_2234} variant="horizontal" tone="dark" />
        </div>
      </section>
    </div>
  );
